  ...
  object dxPageControl1: TdxPageControl
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object dxButton9: TdxButton
        ...
        TabOrder = 1
        ActionOnClick = '<actions><action type="9" id="A1039C22-88FA-4E7A-A030-FDBCED2E7D61" tbl="Методики для заявки" qry="Запрос9" fields="tf;qf;expr|Группа продукции;Группа продукции;|Лаборатория;Лаборатория;|Нормативное значение;Нормативное значение;|Показатель;Показатель;|Примечание;Примечание;|Продукция;Продукция;|Консервация;Консервация;|Вид упаковки;Вид упаковки;|Номер_образца;Номер_образца;" noclr="1" prompt="" /></actions>'
      end
    end
  end
