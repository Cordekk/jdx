object Form243: TdxForm
  ...
  object dxButton1: TdxButton
    ...
    TabOrder = 3
    ActionOnClick = '<actions><action type="2" template="" expression="GET(''Шаблоны1'', ''Файл'')" outfile="" fileaction="1" saverecord="1"/></actions>'
  end
