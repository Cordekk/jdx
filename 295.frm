object Form295: TdxForm
  ...
  object dxButton1: TdxButton
    ...
    TabOrder = 2
    ActionOnClick = '<actions><action type="2" template="" expression="GET(''Шаблоны5'', ''Файл'')" outfile="" fileaction="1" saverecord="1"/></actions>'
  end
  ...
  object dxLabel3: TdxLabel
    ...
    Top = 168
    Width = 177
    Caption = 'Образование по профилю'
    ParentColor = False
  end
