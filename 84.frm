object Form84: TdxForm
  ...
  object dxButton1: TdxButton
    ...
    TabOrder = 3
    ActionOnClick = '<actions><action type="2" template="Почта.odt" expression="" outfile="" fileaction="1" saverecord="1"/></actions>'
  end
  object Grid: TdxGrid
    Left = 0
    Height = 100
